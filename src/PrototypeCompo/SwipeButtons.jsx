  ...
  return (
    <div className="flex justify-center space-x-6">
      <button
        ...
        disabled={disabled}
        className="p-4 rounded-full bg-red-400 text-white shadow-lg hover:bg-red-600 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
